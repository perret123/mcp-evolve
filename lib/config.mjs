...
const DEFAULTS = {
  ...
  // --- Init & question set configuration ---

  /** Total questions to generate during init */
  initQuestions: 20,

  /** Percentage of init questions randomly promoted to golden/eval */
  initGoldenPercent: 30,

  /** Consecutive passes before a train question graduates to golden */
  graduationStreak: 10,
...
export async function loadConfig(projectRoot, customConfigPath) {
  ...
  merged.questionSetPath = join(merged.dataDir, 'question-set.json');
