...
const DEFAULTS = {
  ...
  /** Model for answering questions (default: uses CLI default / opus) */
  answererModel: null,

  /** Model for grading answers (default: sonnet) */
  graderModel: 'sonnet',

  /** Model for fixing errors (default: uses CLI default / opus) */
  fixerModel: null,

  /** Model for reviewing descriptions (default: uses CLI default / opus) */
  reviewerModel: null,

  /** Model for generating questions (default: sonnet) */
  questionModel: 'sonnet',

  /** Model for escalation (default: uses CLI default / opus) */
  escalatorModel: null,

  /** Model for feature proposals in competition (default: opus) */
  proposalModel: 'opus',

  /** Model for voting in competition (default: opus) */
  voterModel: 'opus',
